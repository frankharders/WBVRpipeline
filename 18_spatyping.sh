...
spaPATH='/home/wbvr006/GIT/spatyper/';
spaDB='/home/wbvr006/GIT/spatyper/spatyper_db/';
spaOUT="$WORKDIR/18_spaOUT/";
...
python3 $spaPATH/spatyper.py -i $spaIn -db $spaDB -o $spaOUT/$SAMPLE -no_tmp False ;
