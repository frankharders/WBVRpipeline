...
while [ $count1 -le $countA ]; do
	...
	echo -e "$sample \t $res_count \t $res_gene_count \t $res_gene \t $Bacteria \t $MLSTtype \t $amr_gene_count \t $amr_count \t $amr_res_gene \t $punt_total" >> $final_output
